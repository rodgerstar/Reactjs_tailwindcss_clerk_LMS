...
const CourseDetails = () => {
    ...
    const {
        allCourses, calculateRating, calculateNoOfLectures,
        calculateCourseDuration, calculateChapterTime,getToken, currency, backendUrl, userData
    ...
    return courseData ? (
        ...
        justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
            ...
            bg-gradient-to-b from-cyan-100/70'>
                ...
                {/*left column*/}
                <div className='max-w-xl z-10 gray-500'>
                ...
                text-course-details-heading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
                    ...
                    <div
                        className='flex items-center space-x-2 pt-3 pb-1 text-sm'
                    >
                        ...
                        >({courseData.courseRatings.length} {courseData.courseRatings.length > 1 ? 'ratings' : 'rating'})</p>
                    ...
                    <p className='text-sm'>Course by <span
                        className='text-blue-600 underline'>{courseData.educator.name}</span></p>
                            ...
                            {courseData.courseContent.map((chapter, index) => (
                                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                                    ...
                                    ${openSection[index] ? 'max-h-96' : 'max-h-0'}`}>
                                        <ul className='list-disc md:p1-10 pl-4 pr-4 py-2 text-gray-600
                                        border-t border-gray-300'>
                                            {chapter.chapterContent.map((lecture, i) => (
                                                <li key={i} className='flex items-start gap-2 py-1'>
                                                    <img className='w-4 h-4 mt-1' src={assets.play_icon}
                                                         alt="play icon"/>
